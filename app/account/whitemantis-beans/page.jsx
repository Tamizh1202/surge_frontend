...
const WhiteMantisBeans = () => {
  ...
  <div className={styles.validityWrapper}>
    <p>Surge Beans are valid for 12 months from the date they’re earned.</p> 
  </div>
</div>
