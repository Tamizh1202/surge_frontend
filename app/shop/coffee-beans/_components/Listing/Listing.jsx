...
const PRODUCTS = [
  { id: 'prod-0', slug: "indonesia-mariah-0", name: "Indonesia Mariah - Product 0", notes: "Citrus, nutty", price: "AED 60" },
  { id: 'prod-1', slug: "indonesia-mariah-1", name: "Indonesia Mariah - Product 1", notes: "Chocolate, berry", price: "AED 65" },
  { id: 'prod-2', slug: "indonesia-mariah-2", name: "Indonesia Mariah - Product 2", notes: "Caramel, nutty", price: "AED 60" },
  { id: 'prod-3', slug: "ethiopia-yirgacheffe", name: "Ethiopia Yirgacheffe", notes: "Floral, tea-like", price: "AED 75" },
  { id: 'prod-4', slug: "brazil-santos", name: "Brazil Santos Gold", notes: "Low acid, nutty", price: "AED 55" },
  { id: 'prod-5', slug: "colombia-huila", name: "Colombia Huila Reserve", notes: "Sweet, fruity", price: "AED 70" },
  { id: 'prod-6', slug: "el-salvador-honey", name: "El Salvador Honey Process", notes: "Honey, brown sugar", price: "AED 80" },
  { id: 'prod-7', slug: "indonesia-sumatra", name: "Sumatra Mandheling", notes: "Earthy, spicy", price: "AED 62" },
  { id: 'prod-8', slug: "guatemala-antigua", name: "Guatemala Antigua", notes: "Smoky, chocolate", price: "AED 68" },
];
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.productGrid}>
          {PRODUCTS.slice(0, visibleCount).map((item) => (
            <Link href={`/shop/coffee-beans/${item.slug}`} key={item.id} className={styles.linkWrapper}>
