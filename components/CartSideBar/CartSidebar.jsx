...
// Change this line in CartSideBar.js
                ...
                <div className={styles.prodInfo}>
                  ...
                  <div className={styles.prodFooter}>
                    <div className={styles.qtyControls}>
                      <button><svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.97988 2.16106V3.05706H2.99588V5.21706H1.98788V3.05706H0.00387502V2.16106H1.98788V0.00106239H2.99588V2.16106H4.97988Z" fill="#C4754E"/>
                      ...
                      <button><svg width="5" height="1" viewBox="0 0 5 1" fill="none" xmlns="http://www.w3.org/2000/svg">
