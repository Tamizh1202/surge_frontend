              ...
              <div className={styles.appLinks}>
                <Link href="#" className={styles.appBtn}>
                  <div className={styles.btnContent}>
                    ...
                    >
                      <path
                        d="M3 20.5V3.5C3 2.9 3.5 2.4 4.1 2.5L18.8 11.2C19.3 11.5 19.3 12.5 18.8 12.8L4.1 21.5C3.5 21.6 3 21.1 3 20.5Z"
                        fill="white"
                      />
                    </svg>
