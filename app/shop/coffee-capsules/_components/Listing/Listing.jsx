...
import coffeeImg from './cap.png';


const PRODUCTS = Array(9).fill({
  name: "Mariah Zenith Mariah Triple Wet Hull",
...
const FILTER_DATA = [
  { 
    id: 'cat', 
    title: 'Category', 
    options: ['Whole Bean', 'Ground', 'Coffee Capsules', 'Instant'] 
  },
  { 
    id: 'compatibility', 
    title: 'Machine Compatibility', 
    options: ['Nespresso Original', 'Nespresso Vertuo', 'Keurig K-Cup', 'Dolce Gusto', 'Reusable'] 
  },
 
  { 
    id: 'origin', 
    title: 'Origin', 
    options: ['Brazil', 'Colombia', 'El Salvador', 'Ethiopia', 'Indonesia'] 
  },
  { 
    id: 'process', 
    title: 'Process', 
    options: ['Washed', 'Natural', 'Honey', 'Decaf', 'Anaerobic'] 
  },
];
      ...
      <main className={styles.mainContent}>
        <header className={styles.gridHeader}>
          <div className={styles.titleGroup}>
            <h1 className={styles.mainTitle}>Coffee Capsules</h1>
