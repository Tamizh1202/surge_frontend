      ...
      <main className={styles.mainContent}>
          ...
          <div className={styles.headerActions}>
            ...
            <div className={styles.sortWrapper}>
              <div className={`${styles.sortBox} ${showSort ? styles.activeSortBox : ''}`} onClick={() => setShowSort(!showSort)}>
                ...
                <svg className={`${styles.sortArrow} ${showSort ? styles.arrowRotate : ''}`} width="12" height="8" viewBox="0 0 12 8" fill="none">
        ...
        <div className={styles.productGrid}>
          {PRODUCTS.slice(0, visibleCount).map((item) => (
            <Link href={`/shop/coffee-dripbags/${item.slug}`} key={item.id} className={styles.linkWrapper}>
